...
Sistema de triagem do Pronto-Socorro do Hospital São Binário usando uma Fila de Prioridade baseada em Heap Binário.

Os pacientes são atendidos por ordem de prioridade clínica (não de chegada). A prioridade é definida por 3 critérios em cascata:

1. Nível de urgência (1 a 5) - maior atende primeiro
2. Tempo de espera - maior espera atende primeiro
3. Grupo vulnerável (menores de 12 ou maiores de 65) - tem preferência
